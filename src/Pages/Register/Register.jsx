...
const Regiter = () => {
    ...
    const onFinish = (value) => {
        ...
        if (JSON.parse(localStorage.getItem("regiter")) === null) {
            ...
            swal("Successful!", "Please log in with your registered credentials!", "success");
            navigate('/login');
            ...
            <div className="regiter-main" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" >
                ...
                >
                    ...
                    <Form.Item {...tailFormItemLayout}>
                        ...
                        <p className='login-account'>You are have account ?</p> <Link className='login-now' to="/login">Login now!</Link>
                    </Form.Item>
                </Form>
            </div>
        </div>
