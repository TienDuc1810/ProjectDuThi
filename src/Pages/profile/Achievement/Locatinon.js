    ...
    <>
            ...
            <div>
              <Row>
                <Col size={['l-3', 'm-6', 's-12']} className={cx('item-1')}>
                  <Link className={cx('Choice-info')}> Players</Link>
                </Col>
                <Col size={['l-3', 'm-6', 's-12']} className={cx('item-1')}>
                  <Link className={cx('Choice-info')}> Champion</Link>
                </Col>
                <Col size={['l-3', 'm-6', 's-12']} className={cx('item-1')}>
                  <Link className={cx('Choice-info')}> Gallery</Link>
                </Col>
                <Col size={['l-3', 'm-6', 's-12']} className={cx('item-1')}>
                  <Link className={cx('Choice-info')}> Jersy</Link>
                </Col>
              </Row>
            </div>
          </Col>
      ...
      <div className={cx('item-3')}>
        <div className={cx('Info-player-a')}>
          ...
          <Link className={cx('Info-link')}> Peter Thugs</Link>
        ...
        <div className={cx('Info-player-b')}>
          ...
          <Link className={cx('Info-link')}> Chris Morshal</Link>
          <span>Midfilder</span>
        </div>
        <div className={cx('Info-player-a')}>
          <div className={cx('Image-player')}>
          ...
          <Link className={cx('Info-link')}> John Sharp</Link>
          <span>Goal Kepper</span>
        </div>
        <div className={cx('Info-player-b')}>
          <div className={cx('Image-player')}>
          ...
          <Link className={cx('Info-link')}> Mike Flame</Link>
          <span>Midfilder</span>
        </div>
      </div>
    </>
